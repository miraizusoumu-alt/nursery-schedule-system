import { evaluateConsecutiveWorkLimitForDate } from "./scheduled-work.mjs";
...
function evaluateStaffForQuarterHourSlot(staff, slot, options = {}) {
  ...
  const hasProtectedNonWorkSchedule = existingScheduleDay?.dayType === "day_off"
    || existingScheduleDay?.dayType === "paid_leave";
