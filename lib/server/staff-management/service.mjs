    ...
    return {
      staff: staff.map((entry) => {
        const account = database.prepare(
          `SELECT id, login_id, temporary_password_issued_at, last_login_at, disabled_at, created_at, updated_at
        ...
        return {
          ...
          account: account ? {
            ...
            temporaryPasswordIssuedAt: account.temporary_password_issued_at,
