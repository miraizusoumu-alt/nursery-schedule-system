...
export function createFamilyScheduleService({ database, now = () => new Date() }) {
  ...
  function administratorQuarterHourStaffingCandidates(actor, input = {}) {
    ...
    const requirements = administratorStaffingRequirements(actor, input);
    const quarterHours = aggregateStaffingRequirementsToQuarterHours(requirements.slots);
